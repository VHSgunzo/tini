...
[![Build Status](https://travis-ci.org/VHSgunzo/tini.svg?branch=master)](https://travis-ci.org/VHSgunzo/tini)
...
to manually invoke Tini:
    ...
    # Add Tini
    ENV TINI_VERSION v0.20.0
    ADD https://github.com/VHSgunzo/tini/releases/download/${TINI_VERSION}/tini-x86_64 /tini
    RUN chmod +x /tini
    ENTRYPOINT ["/tini", "--"]
...
Special thanks to:
  ...
  [11]: https://github.com/VHSgunzo/tini/releases
  [12]: https://github.com/VHSgunzo/tini/pull/114
